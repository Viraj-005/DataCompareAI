  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        {projects.map((p) => (
          <div key={p.id} onClick={() => navigate(`/projects/${p.id}`)} className="glass-card p-5 hover:border-dark-400/50 transition-smooth group cursor-pointer">
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="relative">
                ...
                {menuOpen === p.id && (
                  <div className="absolute right-0 top-8 bg-dark-600 border border-dark-500/30 rounded-lg shadow-xl py-1 min-w-[120px] z-10">
                    <button onClick={() => editProject(p)} className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-300 hover:bg-dark-500 transition-smooth">
                      <Edit3 size={14} /> Edit
                    </button>
                    <button onClick={() => { deleteProject(p.id); setMenuOpen(null); }} className="w-full flex items-center gap-2 px-3 py-2 text-sm text-red-400 hover:bg-dark-500 transition-smooth">
            ...
            <div className="flex items-center gap-3 text-xs text-gray-500 mt-auto pt-2 border-t border-dark-500/20">
