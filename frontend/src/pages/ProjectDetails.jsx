  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4 mb-6">
        <button onClick={() => navigate('/projects')} className="p-2 text-gray-400 hover:text-white transition-smooth rounded-lg hover:bg-dark-600">
            <ArrowLeft size={18} />
        </button>
        <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        ...
        <div className="glass-card p-4">
            ...
            <div className="text-xl font-semibold text-white">{new Date(project.updated_at).toLocaleDateString()}</div>
        </div>
      </div>
                    ...
                    <tbody>
                        ...
                        {files.map(f => (
                            <tr key={f.id} className="border-b border-dark-500/10 hover:bg-dark-600/30 transition-smooth">
                                <td className="px-5 py-3.5 text-sm text-gray-200">{f.original_filename}</td>
